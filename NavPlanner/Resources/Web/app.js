...
const TRANSLATIONS = {
  ...
  "settings.copyrightP1": { "zh-Hans": "SimNav Studio 是面向航路规划和航图查看的本地优先工具，可在本机数据库上完成机场、航点、航路、SID / STAR / APPROACH 与 nav-overlay 查询。", en: "SimNav Studio is a local-first route planning and chart inspection tool for airports, waypoints, routes, SID / STAR / APPROACH data, and nav-overlay queries from the on-device database." },
  ...
  "settings.copyrightP3": { "zh-Hans": "地图底图、离线地图包和导航数据版权归各自数据来源所有；App 开发者为 MDX-Tom。", en: "Base maps, offline map packages, and navigation data remain copyrighted by their sources. The app developer is MDX-Tom." },
  "settings.githubRepository": { "zh-Hans": "项目 GitHub 仓库：", en: "Project GitHub repository:" },
